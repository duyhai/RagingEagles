package menuPackage
{
	...
	public class RocketTalent extends Talent
	{

		public function RocketTalent() 
		{
			...
			if (Engine.so.data.rocketArray!=undefined)
			{
				talents=Vector2D.deepcopy(Engine.so.data.rocketArray);
		...
		private function buttonClick(e:Event):void
		{
			...
			Engine.so.data.rocketArray=Vector2D.deepcopy(talents);
			Engine.so.flush();
		}
