package menuPackage
{
	...
	public class DrillTalent extends Talent
	{

		public function DrillTalent(stageRef:Stage = null) 
		{
			...
			if (Engine.so.data.drillArray!=undefined)
			{
				talents=Vector2D.deepcopy(Engine.so.data.drillArray);
		...
		private function buttonClick(e:Event):void
		{
			...
			Engine.so.data.drillArray=Vector2D.deepcopy(talents);
			Engine.so.flush();
		}
