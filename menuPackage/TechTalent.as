package menuPackage
{
	...
	public class TechTalent extends Talent
	{

		public function TechTalent(stageRef:Stage = null) 
		{
			...
			if (Engine.so.data.techArray!=undefined)
			{
				talents=Vector2D.deepcopy(Engine.so.data.techArray);
		...
		private function buttonClick(e:Event):void
		{
			...
			Engine.so.data.techArray=Vector2D.deepcopy(talents);
			Engine.so.flush();
		}
