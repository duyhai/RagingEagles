package menuPackage
{
	...
	public class BerserkTalent extends Talent
	{

		public function BerserkTalent(stageRef:Stage = null) 
		{
			...
			if (Engine.so.data.berserkArray!=undefined)
			{
				talents=Vector2D.deepcopy(Engine.so.data.berserkArray);
		...
		private function buttonClick(e:Event):void
		{
			...
			Engine.so.data.berserkArray=Vector2D.deepcopy(talents);
			Engine.so.flush();
		}
